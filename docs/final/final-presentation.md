...
- Begin demo (add/view/edit/delete workflow)
...
- Final system stability improvements
...
4. Edit a workout
5. Delete a workout
6. Refresh page to show persistence (localStorage)

---

## Backup Plan

- **Primary fallback:** Gary runs the app locally and takes over screen share
- **Secondary fallback:** Pre-recorded demo video
- **Tertiary fallback:** Slides with screenshots of key workflows

---

## Notes

The presentation will be rehearsed to ensure smooth transitions, equal participation, and clear explanation of both functionality and technical decisions.
